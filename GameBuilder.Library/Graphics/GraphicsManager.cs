...
{
    /// <remarks>
    /// Based on code from https://github.com/jikoriko/OpentkEngine
    /// </remarks>
    public class GraphicsManager
    {
        ...
        private static Color4 _clearColor = Color4.CornflowerBlue;
        ...
        public static void Initialize(GLControl glControl)
        {
            _window = glControl.ClientRectangle;
            Initialize();
        }
        ...
        public static void Draw(GLControl glControl)
        {
            DrawText("This is a test", 0, 0, 0, Color4.Beige);
            DrawText("This is a test", 0, 0, -1, Color4.Beige);
            DrawText("This is a test", 0, 0, 1, Color4.Beige);
            DrawText("This is a test", 0, 1, 1, Color4.Beige);
            DrawText("This is a test", 1, 1, 1, Color4.Beige);
