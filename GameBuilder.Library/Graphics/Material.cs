...
namespace GameBuilder.Library.Graphics
{
    public class Material
    {
        ...
        public void Bind()
        {
            int uAmbientReflectivityLocation = GraphicsManager.GetShader().GetUniformLocation("uMaterial.AmbientReflectivity");
            GL.Uniform3(uAmbientReflectivityLocation, Ambient);
            int uDiffuseReflectivityLocation = GraphicsManager.GetShader().GetUniformLocation("uMaterial.DiffuseReflectivity");
            GL.Uniform3(uDiffuseReflectivityLocation, Diffuse);
            int uSpecularReflectivityLocation = GraphicsManager.GetShader().GetUniformLocation("uMaterial.SpecularReflectivity");
            GL.Uniform3(uSpecularReflectivityLocation, Specular);
            int uShininessLocation = GraphicsManager.GetShader().GetUniformLocation("uMaterial.Shininess");
