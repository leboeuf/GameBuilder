...
namespace GameBuilder.Library.Graphics
{
    public class ModelMesh
    {
        ...
        private void BindVBO()
        {
            ...
            int vPositionLocation = GraphicsManager.GetShader().GetAttribLocation("vPosition");
            int vNormalLocation = GraphicsManager.GetShader().GetAttribLocation("vNormal");
            GL.EnableVertexAttribArray(vPositionLocation);
            GL.EnableVertexAttribArray(vNormalLocation);

            if (_texCoords)
            {
                int vTexCoordsLocation = GraphicsManager.GetShader().GetAttribLocation("vTexCoords");
