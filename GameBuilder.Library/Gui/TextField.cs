...
namespace GameBuilder.Library.Gui
{
    public class TextField : Control, KeyListener
    {
        ...
        {
            int height = Graphics.GraphicsManager.GetFont().GetLineHeight();
        ...
        {
            int cursorX = _body.X + 1 + Graphics.GraphicsManager.GetFont().GetWidth(_text.Substring(0, _cursorPos));
        ...
        public override void RenderContent()
        {
            ...
            BitmapFont font = Graphics.GraphicsManager.GetFont();
            int textHeight = font.GetHeight(_text);

            Graphics.GraphicsManager.DrawText(_text, _offsetX, _content.Height - textHeight, 0, Color4.Black);

            int cursorX = font.GetWidth(_text.Substring(0, _cursorPos));
            cursorX += 1 + _offsetX;
            if (_active)
                Graphics.GraphicsManager.FillRect(cursorX, 1, 0, 2, _content.Height - 2, Color4.Black);
        }
